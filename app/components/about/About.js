    ...
    <div className='absolute top-10 left-1/2   border border-white-700  -translate-x-1/2   z-30   text-white bg-[#111] rounded-lg p-7'>
      ...
      <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-5">
        <div className="pt-8">
          ...
          <p className='text-xl pt-2 text-justify'>I am Mern Stack Developer . I learned these technologies in one year from Saylani Mass IT Program in 2022.
            I mostly use React.js and Next.js framework for development. I know about Mongo-db and Firebase Databse . I know Contentful CMS and Sanity CMS . I am also using Tailwind css in projects  </p>
